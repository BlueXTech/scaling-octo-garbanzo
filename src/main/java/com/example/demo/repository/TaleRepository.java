...
//                .addReadBatch(ReadBatch.builder(TaleMetadata.class).mappedTableResource(table).addGetItem(Key.builder().partitionValue("TALE#tale1").sortValue("#METADATA").build()).build())
//                .addReadBatch(ReadBatch.builder(Route.class).mappedTableResource(routeTable).addGetItem(Key.builder().partitionValue("TALE#tale1").sortValue("ITINERARY#ROUTE#route1").build()).build())
//                .build();
//
//        BatchGetResultPageIterable resultPages = client.batchGetItem(req);
//        System.out.println("Got result pages");
//
//        System.out.println(resultPages.stream().toList().get(0).resultsForTable(table).get(0));
//        System.out.println(resultPages.stream().toList().get(0).resultsForTable(routeTable).get(1));